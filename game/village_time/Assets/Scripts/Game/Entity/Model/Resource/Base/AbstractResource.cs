...
public abstract class AbstractResource : MonoBehaviour, IResource {
    ...
    public float GetMax() {
        return this._max != null ? this._max.Value : AbstractResource.DEFAULT_MAX;
    }
    public float GetMin() {
        return this._min != null ? this._min.Value : AbstractResource.DEFAULT_MIN;
    }
