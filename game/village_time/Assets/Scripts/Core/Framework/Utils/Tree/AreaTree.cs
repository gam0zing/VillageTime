...
public class AreaTree<TValue> where TValue : class, ITreePoint {
    protected class AreaNode {
        ...
        public readonly AreaTree<TValue> tree;
        ...
        public AreaNode(AreaTree<TValue> tree, AreaNode parent, Action<AreaNode> setRootFunc, int forkNum, int posX, int posY, int sizeX, int sizeY) {
            this.tree = tree;
            this.parent = parent;
